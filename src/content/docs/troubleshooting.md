...
description: Solutions to common issues when deploying Laravel on UConn OpenShift
---
...
SQLite is a single-writer database. See the [persistent storage guide](/guides/persistent-storage/#sqlite-and-replicas) for migration options.
...
If you use the [OpenShift Template](/templates/openshift-templates/), always pass `-p APP_URL=https://<your-route-host>` when deploying.
