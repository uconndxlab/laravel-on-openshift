---
title: Automating Container Image Builds on Git Push
description: Set up a Tekton pipeline for automated Laravel builds and deployments on OpenShift
---
...
Instead of `oc set image`, you can use the [OpenShift Template](/templates/openshift-templates/) to deploy the full set of resources in a single step:
...
With [ArgoCD](/templates/argocd/), your pipeline only needs to **build and push the image**. ArgoCD monitors your Git repository and syncs the deployment automatically:
...
See the [persistent storage guide](/guides/persistent-storage/#c-automate-in-cicd) for more details.
