> **Archived**: This page covers the deprecated Paketo buildpack approach. The current recommendation is to use a [Containerfile](../../images/containerfile.md) checked into your project root and build via OpenShift's Git-based Deployments feature.
