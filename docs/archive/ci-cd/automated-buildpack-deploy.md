> **Archived**: This page covers the deprecated buildpack-based CI/CD approach. The current recommendation is the [Containerfile-based CI/CD guide](../../ci-cd/automated-deploy.md) which builds from a Dockerfile in your Git repo.
